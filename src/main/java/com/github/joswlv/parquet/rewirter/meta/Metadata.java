...
public class Metadata implements Serializable {
  ...
  private List<String> jobTablePath;
  ...
  public Metadata(String keyColName,
      Set<String> keyColValueList, Set<String> targetColNameList) {
    this.keyColName = keyColName;
    this.keyColValueList = keyColValueList;
    this.targetColNameList = targetColNameList;
  }

  public List<String> getJobTablePath() {
    return jobTablePath;
  }
