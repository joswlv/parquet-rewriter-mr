...
public class ParquetMetaInfoChecker {
    ...
    private boolean isExistColValueInRowGroup(BlockMetaData blockMetaData, int keyColIndex, Set<String> keyColValueList) {

        ColumnChunkMetaData columnChunkMetaData = blockMetaData.getColumns().get(keyColIndex);
        for (String keyColValue : keyColValueList) {

            int compareMinResult = compareStatistics(columnChunkMetaData, keyColValue, new MinStatisticsCompare());
            int compareMaxResult = compareStatistics(columnChunkMetaData, keyColValue, new MaxStatisticsCompare());
    ...
    private int compareStatistics(ColumnChunkMetaData columnChunkMetaData, String keyColValue, StatisticsCompare statisticsCompare) {

        PrimitiveTypeName primitiveTypeName = columnChunkMetaData.getPrimitiveType().getPrimitiveTypeName();
